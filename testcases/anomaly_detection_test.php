 ...
 */
class LL_AnomalyDetectionTest extends PHPUnit_TestCase {
...
$suite->addTest(new LL_AnomalyDetectionTest('testIsAnomaly'));

$suite->addTest(new LL_AnomalyDetectionTest('testIsAnomalyOnline'));
