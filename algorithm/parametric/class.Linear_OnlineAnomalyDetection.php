...
/**
 * class.Linear_OnlineAnomalyDetection.php
 *
...
if (!class_exists("Linear_OnlineAnomalyDetection")) {

// online anomaly detector, can addObservations instead of only training once.
    class Linear_OnlineAnomalyDetection extends Linear_AnomalyDetection {
...
if (!class_exists("Linear_AnomalyDetection")) {

// main implementation class
    class Linear_AnomalyDetection {
         ...
         *
         * Example Usage:
         *   $ll = new Linear_AnomalyDetection();
